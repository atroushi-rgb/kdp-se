...
<style>
<!--
body,td, tr { font-family: Unikurd Web, Tahoma;
      color:#000;
      font-size:10pt;
      text-align:justify;
     }
...
if($subaction == "" or !isset($subaction)){
        ...
        if(is_array($arch_arr)){
                ...
                foreach($arch_arr as $arch_file){
                                ...
                                echo"<table width=\"450\"><tr><td bgcolor=\"#cccccc\"><center><div style=font-family=\"verdana\" style=font-size=\"12px\"> <a href=\"$PHP_SELF?archive=$arch_file&subaction=list-archive&$user_query\">". date("M Y",$last_timestamp)."</a></div><br /><center></td></tr></table>";
                }
                }
}
else{
